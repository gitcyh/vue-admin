        ...
        <el-table-column align="center" fixed="right"  label="操作" width="160">
            <template #default="scope">
                <el-button-group>
                    ...
                    <el-button :icon="Position" type="primary" size="small" @click="checkShop(scope.$index, scope.row)">审核</el-button>
                </el-button-group>
            </template>
        </el-table-column>
    </el-table>
...
const filterTableData = computed(() =>
    tableData.value.filter(data=>{
        ...
        if(!value){
            ...
            return data.shopName.includes(value) || data.shopAddress.includes(value) || data.shopTel.includes(value)
