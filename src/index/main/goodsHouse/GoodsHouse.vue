    ...
    <el-table :data="filterTableData" border  style="width: 100%">
        ...
        <el-table-column align="right"  label="操作" >
            <template #default="scope">
                <el-button-group>
                    <!-- <el-button :icon="Top" type="success" size="small" @click="handleEdit(scope.$index, scope.row)">上架</el-button>-->
                     <el-button :icon="View" size="small" type="warning" @click="handleView(scope.$index, scope.row)">查看</el-button>
