            ...
            <div>
                <el-form ref="ruleFormRef" :model="ruleForm" :rules="useOrderCheck.rules" label-width="120px" class="demo-ruleForm">
                    ...
                    <el-form-item label="价格" prop="price">
                        <el-input-number v-model="data.price" :min="0"  size="small" :controls="false" style="width: 100%"/>
                    </el-form-item>
                    <el-form-item label="数量" prop="num">
                        <el-input-number v-model="data.num" :min="0"  size="small" :controls="false" style="width: 100%"/>
                    </el-form-item>
